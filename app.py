...
<head>
    ...
    <title>מוריד הסרטונים מ-YouTube (גרסה מקומית יציבה)</title>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="status">גרסה מקומית - ללא חסימות וללא מגבלות</div>
    </div>
</body>
</html>
'''
...
def download():
    ...
    try:
        ...
        # הגדרות מותאמות להורדה מקומית חסינה
        ydl_opts = {
        ...
        if os.path.exists(output_path):
            ...
            return "הקובץ לא נשמר בהצלחה.", 500

    except Exception as e:
        return f"שגיאה בהורדת הסרטון: {str(e)}", 500

if __name__ == '__main__':
    print("השרת המקומי פועל! פתח את הדפדפן בכתובת: http://127.0.0.1:5000")
